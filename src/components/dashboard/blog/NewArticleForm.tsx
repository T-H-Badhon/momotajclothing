...
import { handleAddArticle } from 'src/components/actions/actionArticles';
...
export default function NewArticleForm({
    ...
    const removeSelectedImage = () => {
        setBase64Image(null);
        // dispatch(updateFormField({ field: "image", value: "" }));
    };
    ...
    async function clientAction() {
        ...
        const result = await handleAddArticle({
            ...formData,
            content,
        ...
        if (result?.success) {
            ...
            toast.error('There was an error adding new article');
        }
    }
